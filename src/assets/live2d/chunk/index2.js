...
class e {
  ...
  pushBack(t) {
    ;(this._size >= this._capacity &&
      this.prepareCapacity(0 == this._capacity ? e.DefaultSize : 2 * this._capacity),
...
class _ {
  ...
  registerId(t) {
    ...
    return 'string' != typeof t
      ? this.registerId(t.s)
      : (null != (e = this.findId(t)) || ((e = d.createIdInternal(t)), this._ids.pushBack(e)), e)
  }
  getId(t) {
...
class z extends T {
  ...
  getValueByIndex(t) {
    if (t < 0 || this._array.getSize() <= t)
      return T.errorValue.setErrorNotForClientCall('Error: index out of bounds')
...
class U extends T {
  ...
  getValueByString(t) {
    ...
    for (let e = this._map.begin(); e.notEqual(this._map.end()); e.preIncrement())
      if (e.ptr().first == t) return null == e.ptr().second ? T.nullValue : e.ptr().second
    return T.nullValue
  }
  getValueByIndex(t) {
    return T.errorValue.setErrorNotForClientCall(R)
...
class $ {
  static startUp(t = null) {
    ...
    if (
      ((H = t), null != H && Live2DCubismCore.Logging.csmSetLogFunction(H.logFunction), (Y = !0), Y)
    ) {
...
class nt {
  ...
  initialize(t) {
    return (
      ...
      !!this._gl ||
        (alert('Cannot initialize WebGL. This browser does not support.'), (this._gl = null), !1)
    )
  }
  release() {}
  getGl() {
...
class pt extends mt {
  ...
  getMotionCount(t) {
    return this.isExistMotionGroupName(t)
      ? this._jsonValue.at(ut.FrequestNode_Motions).getValueByString(t).getSize()
      : 0
  }
  ...
  getEyeBlinkParameterCount() {
    ...
    let t = 0
    for (let e = 0; e < this._jsonValue.at(ut.FrequestNode_Groups).getSize(); e++) {
  ...
  isExistEyeBlinkParameters() {
    if (
      ...
      return !1
    for (let t = 0; t < this._jsonValue.at(ut.FrequestNode_Groups).getSize(); ++t)
      if (
        this._jsonValue
...
class ft {
  ...
  updateParameters(t, e) {
    ...
    for (let e = 0; e < this._breathParameters.getSize(); ++e) {
      ...
      t.addParameterValueById(s.parameterId, s.offset + s.peak * Math.sin(i / s.cycle), s.weight)
    }
  }
  constructor() {
    this._currentTime = 0
  ...
  doFade(t, e, i, s) {
    ...
    for (let n = i; n < i + s; ++n) {
      ...
      if (t.getParameterValueByIndex(s) > 0.001) {
        ...
        ;((a = t.getPartOpacityByIndex(i)), (a += e / this._fadeTimeSeconds), a > 1 && (a = 1))
      }
    }
    r < 0 && ((r = 0), (a = 1))
    for (let e = i; e < i + s; ++e) {
...
class Vt {
  ...
  static mod(t, e) {
    if (!isFinite(t) || 0 === e || isNaN(t) || isNaN(e))
      return (console.warn(`divided: ${t}, divisor: ${e} mod() returns 'NaN'.`), NaN)
    const i = Math.abs(t),
      s = Math.abs(e)
    ...
    return (
      (i =
        ...
        (0 == this._fadeInSeconds
          ? 1
          : Vt.getEasingSine((e - t.getFadeInStartTime()) / this._fadeInSeconds)) *
...
class Ot extends Lt {
      ...
      for (let e = 0; e < s.getSize(); ++e) {
        ...
        if (l < 0) {
          0 == r
            ? ((i.additiveValue = Ot.DefaultAdditiveValue),
              ...
              (i.overwriteValue = n))
            : ((i.additiveValue = this.calculateValue(i.additiveValue, Ot.DefaultAdditiveValue, a)),
              (i.multiplyValue = this.calculateValue(i.multiplyValue, Ot.DefaultMultiplyValue, a)),
        ...
        switch (o.at(l).blendType) {
          ...
          case kt.Multiply:
            ...
            break
          case kt.Overwrite:
            ;((u = Ot.DefaultAdditiveValue), (g = Ot.DefaultMultiplyValue), (d = h))
            break
          default:
            return
        }
        0 == r
          ? ((i.additiveValue = u), (i.multiplyValue = g), (i.overwriteValue = d))
  ...
  parse(t, e) {
    ...
    for (let t = 0; t < r; ++t) {
      ...
      let a
      a =
        e.getValueByString(At).isNull() || 'Add' == e.getValueByString(At).getString()
          ? kt.Additive
  ...
  doUpdateMotion(t, e) {
    ...
    for (let s = this._motions.begin(); s.notEqual(this._motions.end()); ) {
      ...
      ;(r.setLastCheckEventSeconds(e),
        r.isFinished()
          ? (r.release(), (r = null), (s = this._motions.erase(s)))
          : (r.isTriggeredFadeOut() && r.startFadeOut(r.getFadeOutSeconds(), e), s.preIncrement()))
    }
    return i
  }
}
...
class Zt extends Xt {
  ...
  release() {
    ;(this._expressionParameterValues &&
      (J(this._expressionParameterValues), (this._expressionParameterValues = null)),
  ...
  getFadeWeight(t) {
    return t < 0 || this._fadeWeights.getSize() < 1 || t >= this._fadeWeights.getSize()
      ? (console.warn(
      ...
      if (n.isAvailable())
        for (let e = 0; e < l.getSize(); ++e) {
          ...
          for (let t = 0; t < this._expressionParameterValues.getSize(); ++t)
            if (this._expressionParameterValues.at(t).parameterId == l.at(e).parameterId) {
              i = t
              break
            }
          if (i >= 0) continue
      ...
      ;(o.setupMotionQueueEntry(n, this._userTimeSeconds),
        ...
        (r +=
          0 == o.getFadeInTime()
            ? 1
            : Vt.getEasingSine(
                (this._userTimeSeconds - n.getFadeInStartTime()) / o.getFadeInTime()
              )),
        (i = !0),
        n.isTriggeredFadeOut() && n.startFadeOut(n.getFadeOutSeconds(), this._userTimeSeconds),
        e.preIncrement(),
        ++a)
    }
    if (s.getSize() > 1) {
...
class he {
  ...
  getEvaluationOptionFlag(t) {
    return (
      ...
      this._json.getRoot().getValueByString(se).getValueByString('AreBeziersRestricted').toBoolean()
    )
  }
  getMotionCurveCount() {
  ...
  for (let e = a.baseSegmentIndex; e < o; ++e)
    if (
      ((l =
        ...
        (t.segments.at(e).segmentType == Wt.CubismMotionSegmentType_Bezier ? 3 : 1)),
...
class Be extends Lt {
  ...
  doUpdateParameters(t, e, i, s) {
    ;(null == this._modelCurveIdEyeBlink &&
      ...
      null == this._modelCurveIdOpacity && (this._modelCurveIdOpacity = $.getIdManager().getId(de)),
    ...
    const u =
        this._fadeInSeconds <= 0
          ? 1
          : Vt.getEasingSine((e - s.getFadeInStartTime()) / this._fadeInSeconds),
      g =
    ...
    if (this._isLoop)
      for (
        this._motionBehavior === Ce.MotionBehavior_V2 && (p += 1 / this._motionData.fps);
        m > p;
    ...
    for (
      _ = 0;
      _ < this._motionData.curveCount && y.at(_).type == qt.CubismMotionCurveTarget_Model;
      ++_
    )
    ...
    for (
      ;
      _ < this._motionData.curveCount && y.at(_).type == qt.CubismMotionCurveTarget_Parameter;
      ++_
    ) {
      ...
      if (
        ...
        ;((t =
          y.at(_).fadeInTime < 0
            ...
            : 0 == y.at(_).fadeInTime
              ? 1
              : Vt.getEasingSine((e - s.getFadeInStartTime()) / y.at(_).fadeInTime)),
          (i =
    ...
    for (
      ;
      _ < this._motionData.curveCount && y.at(_).type == qt.CubismMotionCurveTarget_PartOpacity;
      ++_
    )
      ((c = t.getParameterIndex(y.at(_).id)),
        -1 != c && ((d = Se(this._motionData, _, m, f, p)), t.setParameterValueByIndex(c, d)))
    ;(r >= p &&
      (this._isLoop
  ...
  setIsLoopFadeIn(t) {
    ;(v('setIsLoopFadeIn() is a deprecated function. Please use setLoopFadeIn().'),
      (this._isLoopFadeIn = t))
  }
  isLoopFadeIn() {
    return (
  ...
  parse(t, e, i = !1) {
    ...
    const r = s.getEvaluationOptionFlag(ue.EvaluationOptionFlag_AreBeziersRistricted)
    ;(s.isExistMotionFadeInTime()
      ? (this._fadeInSeconds = s.getMotionFadeInTime() < 0 ? 1 : s.getMotionFadeInTime())
      : (this._fadeInSeconds = 1),
      s.isExistMotionFadeOutTime()
        ? (this._fadeOutSeconds = s.getMotionFadeOutTime() < 0 ? 1 : s.getMotionFadeOutTime())
        : (this._fadeOutSeconds = 1),
      this._motionData.curves.updateSize(this._motionData.curveCount, te, !0),
      this._motionData.segments.updateSize(s.getMotionTotalSegmentCount(), Qt, !0),
    ...
    for (let t = 0; t < this._motionData.curveCount; ++t) {
      ;('Model' == s.getMotionCurveTarget(t)
        ? (this._motionData.curves.at(t).type = qt.CubismMotionCurveTarget_Model)
        : 'Parameter' == s.getMotionCurveTarget(t)
          ? (this._motionData.curves.at(t).type = qt.CubismMotionCurveTarget_Parameter)
          : 'PartOpacity' == s.getMotionCurveTarget(t)
            ? (this._motionData.curves.at(t).type = qt.CubismMotionCurveTarget_PartOpacity)
            : v(
        ...
        (this._motionData.curves.at(t).fadeInTime = s.isExistMotionCurveFadeInTime(t)
          ? s.getMotionCurveFadeInTime(t)
          : -1),
        (this._motionData.curves.at(t).fadeOutTime = s.isExistMotionCurveFadeOutTime(t)
          ? s.getMotionCurveFadeOutTime(t)
          : -1))
      for (let e = 0; e < s.getMotionCurveSegmentCount(t); ) {
        0 == e
          ? ((this._motionData.segments.at(n).basePointIndex = a),
            (this._motionData.points.at(a).time = s.getMotionCurveSegment(t, e)),
            (this._motionData.points.at(a).value = s.getMotionCurveSegment(t, e + 1)),
            (a += 1),
            (e += 2))
        ...
        switch (s.getMotionCurveSegment(t, e)) {
          case Wt.CubismMotionSegmentType_Linear:
            ;((this._motionData.segments.at(n).segmentType = Wt.CubismMotionSegmentType_Linear),
              ...
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(t, e + 1)),
              (this._motionData.points.at(a).value = s.getMotionCurveSegment(t, e + 2)),
              (a += 1),
              (e += 3))
            break
          case Wt.CubismMotionSegmentType_Bezier:
            ;((this._motionData.segments.at(n).segmentType = Wt.CubismMotionSegmentType_Bezier),
              (this._motionData.segments.at(n).evaluate = r ? me : pe),
              (this._motionData.points.at(a).time = s.getMotionCurveSegment(t, e + 1)),
              (this._motionData.points.at(a).value = s.getMotionCurveSegment(t, e + 2)),
              (this._motionData.points.at(a + 1).time = s.getMotionCurveSegment(t, e + 3)),
              (this._motionData.points.at(a + 1).value = s.getMotionCurveSegment(t, e + 4)),
              (this._motionData.points.at(a + 2).time = s.getMotionCurveSegment(t, e + 5)),
              (this._motionData.points.at(a + 2).value = s.getMotionCurveSegment(t, e + 6)),
              (a += 3),
              (e += 7))
            break
          case Wt.CubismMotionSegmentType_Stepped:
            ;((this._motionData.segments.at(n).segmentType = Wt.CubismMotionSegmentType_Stepped),
  ...
  isExistModelOpacity() {
    for (let t = 0; t < this._motionData.curveCount; t++) {
      ...
      if (e.type == qt.CubismMotionCurveTarget_Model && 0 == e.id.getString().s.localeCompare(de))
        return !0
    }
    return !1
  }
...
class ii {
  ...
  parse(t, e) {
    ...
    ;((this._physicsRig.gravity = i.getGravity()),
      ...
      this._physicsRig.settings.updateSize(this._physicsRig.subRigCount, Re, !0),
      ...
      for (let e = 0; e < this._physicsRig.settings.at(t).inputCount; ++e)
        ((this._physicsRig.inputs.at(s + e).sourceParameterIndex = -1),
          ...
          'X' == i.getInputType(t, e)
            ? ((this._physicsRig.inputs.at(s + e).type = be.CubismPhysicsSource_X),
              (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue = ai))
            : 'Y' == i.getInputType(t, e)
              ? ((this._physicsRig.inputs.at(s + e).type = be.CubismPhysicsSource_Y),
                (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue = ni))
              : i.getInputType(t, e) == ei &&
                ((this._physicsRig.inputs.at(s + e).type = be.CubismPhysicsSource_Angle),
                (this._physicsRig.inputs.at(s + e).getNormalizedParameterValue = oi)),
  ...
  stabilization(t) {
    ...
    ;((null !== (i = null === (e = this._parameterCaches) || void 0 === e ? void 0 : e.length) &&
    void 0 !== i
      ? i
    ...
    for (let e = 0; e < this._physicsRig.subRigCount; ++e) {
      ...
      for (let e = 0; e < u.inputCount; ++e)
        ((n = g[e].weight / 100),
          ...
          (this._parameterCaches[g[e].sourceParameterIndex] = c[g[e].sourceParameterIndex]))
  ...
  evaluate(t, e) {
    ...
    if (
      ...
      (null !== (s = null === (i = this._parameterCaches) || void 0 === i ? void 0 : i.length) &&
      void 0 !== s
        ? s
        : 0) < t.getParameterCount() &&
        (this._parameterCaches = new Float32Array(t.getParameterCount())),
    ...
    for (
      ...
      for (let t = 0; t < this._physicsRig.subRigCount; ++t) {
        ...
        for (let e = 0; e < g.outputCount; ++e)
          this._previousRigOutputs.at(t).outputs.set(e, this._currentRigOutputs.at(t).outputs.at(e))
      }
        ...
        for (let i = 0; i < g.outputCount; ++i) {
          ...
          if (
            (-1 == _[i].destinationParameterIndex &&
              (_[i].destinationParameterIndex = t.getParameterIndex(_[i].destination.id)),
  ...
  initialize() {
    ...
    for (let s = 0; s < this._physicsRig.subRigCount; ++s) {
      ;((e = this._physicsRig.settings.at(s)),
        ...
        (t[0].lastPosition = new It(t[0].initialPosition.x, t[0].initialPosition.y)),
      ...
      for (let s = 1; s < e.particleCount; ++s)
        ((i = new It(0, 0)),
          ...
          (t[s].position = new It(t[s].initialPosition.x, t[s].initialPosition.y)),
          (t[s].lastPosition = new It(t[s].initialPosition.x, t[s].initialPosition.y)),
...
function fi(t, e, i, s, r) {
  ...
  ;((a = s * r.getScale(r.translationScale, r.angleScale)),
    a < e
      ...
      : a > i && (a > r.valueExceededMaximum && (r.valueExceededMaximum = a), (a = i)))
...
class Ci {
  ...
  initialize(t, i) {
    ...
    for (let e = 0; e < t.getDrawableCount(); e++) {
      ...
      let i = this.findSameClip(t.getDrawableMasks()[e], t.getDrawableMaskCounts()[e])
      ;(null == i &&
  ...
  setupMatrixForHighPrecision(t, e) {
    ...
    if (i > 0) {
      if (
        ...
        for (let t = 0; t < this._renderTextureCount; t++) this._clearedFrameBufferFlags.set(t, !1)
      for (let i = 0; i < this._clippingContextListForMask.getSize(); i++) {
        const s = this._clippingContextListForMask.at(i),
  ...
  setupLayoutBounds(t) {
    ...
    for (let s = 0; s < this._renderTextureCount; s++)
      for (let l = 0; l < 4; l++) {
        let h = a + (l < n ? 1 : 0)
        if ((l == n + (a < 1 ? -1 : 0) && r > 0 && (h -= s < r ? 0 : 1), 0 == h));
        else if (1 == h) {
...
class Mi {
  ...
  setupShaderProgramForDraw(t, e, i) {
    ...
    ;(this.gl.useProgram(g.shaderProgram),
      null == t._bufferData.vertex && (t._bufferData.vertex = this.gl.createBuffer()),
    ...
    ;(this.gl.bufferData(this.gl.ARRAY_BUFFER, d, this.gl.DYNAMIC_DRAW),
      ...
      this.gl.vertexAttribPointer(g.attributePositionLocation, 2, this.gl.FLOAT, !1, 0, 0),
    ...
    if (
      ...
      this.gl.vertexAttribPointer(g.attributeTexCoordLocation, 2, this.gl.FLOAT, !1, 0, 0),
      o)
    ) {
  ...
  getMaskRenderTexture() {
    if (this._maskTexture && null != this._maskTexture.textures)
      ...
      ;(this.gl.bindFramebuffer(this.gl.FRAMEBUFFER, Di),
        (this._maskTexture = new Oi(this._currentFrameNo, this._maskRenderTextures)))
    }
...
class zi extends p {
  initialize(t, e = 1) {
    ;(t.isUsingMasking() &&
      ((this._clippingManager = new Ai()), this._clippingManager.initialize(t, e)),
  ...
  drawMeshWebGL(t, e) {
    ;(this.isCulling() ? this.gl.enable(this.gl.CULL_FACE) : this.gl.disable(this.gl.CULL_FACE),
      ...
      this.isGeneratingMask()
        ? vi.getInstance().getShader(this.gl).setupShaderProgramForMask(this, t, e)
        : vi.getInstance().getShader(this.gl).setupShaderProgramForDraw(this, t, e))
    {
...
class Wi {
  ...
  isRepeat(t) {
    ...
    return (
      C(0 <= t && t < this.getParameterCount()),
      (e =
        this._isOverriddenParameterRepeat || this._userParameterRepeatDataList.at(t).isOverridden
  ...
  initialize() {
      ...
      (this._parameterMinimumValues = this._model.parameters.minimumValues))
    {
      ...
      ;(this._parameterIds.prepareCapacity(e), this._userParameterRepeatDataList.prepareCapacity(e))
      for (let i = 0; i < e; ++i)
    ...
    const t = this._model.parts.count
    {
      ...
      for (let i = 0; i < t; ++i) this._partIds.pushBack($.getIdManager().getId(e[i]))
...
class Ji {
  static create(t, e) {
    ...
    return (
      s && ((i = new Ji(s)), (i._mocVersion = Live2DCubismCore.Version.csmGetMocVersion(s, t))),
      i
    )
  }
  static delete(t) {
...
class rs {
  ...
  constructor() {
    ;((this._moc = null),
      ...
      this._motionManager.setEventCallback(rs.cubismDefaultMotionEventCallback, this),
      (this._expressionManager = new Zt()),
      (this._dragManager = new Et()))
  }
  release() {
    ;(null != this._motionManager && (this._motionManager.release(), (this._motionManager = null)),
          ...
          try {
              ...
              throw ((i = !1), new Error('Cannot find "data" Chunk.'))
            {
              ...
              this._wavFileInfo._samplesPerChannel =
                (8 * t) / (this._wavFileInfo._bitsPerSample * this._wavFileInfo._numberOfChannels)
            }
      ...
      ;(fetch(`${this._modelHomeDir}${t}`)
        .then((e) =>
          e.ok
            ? e.arrayBuffer()
            : e.status >= 400
              ? (b(`Failed to load file ${this._modelHomeDir}${t}`), new ArrayBuffer(0))
              : void 0
        )
        .then((t) => {
          ;(this.loadModel(t, this._mocConsistency), (this._state = hs.LoadExpression), i())
        }),
    ...
    const i = () => {
            ...
            fetch(`${this._modelHomeDir}${r}`)
              .then((t) =>
                t.ok
                  ? t.arrayBuffer()
                  : t.status >= 400
                    ? (b(`Failed to load file ${this._modelHomeDir}${r}`), new ArrayBuffer(0))
                    : void 0
              )
              .then((e) => {
                const r = this.loadExpression(e, e.byteLength, i)
                ;(null != this._expressions.getValue(i) &&
                  (Lt.delete(this._expressions.getValue(i)), this._expressions.setValue(i, null)),
                  this._expressions.setValue(i, r),
                  this._expressionCount++,
                  this._expressionCount >= t && ((this._state = hs.LoadPhysics), s()))
              })
          }
      ...
      s = () => {
        if ('' != this._modelSetting.getPhysicsFileName()) {
          ...
          ;(fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              ;(this.loadPhysics(t, t.byteLength), (this._state = hs.LoadPose), r())
            }),
      ...
      r = () => {
        if ('' != this._modelSetting.getPoseFileName()) {
          ...
          ;(fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              ;(this.loadPose(t, t.byteLength), (this._state = hs.SetupEyeBlink), a())
            }),
      ...
      a = () => {
        ;(this._modelSetting.getEyeBlinkParameterCount() > 0 &&
          ((this._eyeBlink = St.create(this._modelSetting)), (this._state = hs.SetupBreath)),
          n())
      },
      n = () => {
        ...
        ;(t.pushBack(new yt(this._idParamAngleX, 0, 15, 6.5345, 0.5)),
          ...
          t.pushBack(new yt($.getIdManager().getId(ot.ParamBreath), 0.5, 0.5, 3.2345, 1)),
      ...
      o = () => {
        if ('' != this._modelSetting.getUserDataFile()) {
          ...
          ;(fetch(`${this._modelHomeDir}${t}`)
            ...
            .then((t) => {
              ;(this.loadUserData(t, t.byteLength), (this._state = hs.SetupEyeBlinkIds), l())
            }),
        ...
        (fetch(`${this._modelHomeDir}${a}`)
          .then((t) =>
            t.ok
              ? t.arrayBuffer()
              : t.status >= 400
                ? (b(`Failed to load file ${this._modelHomeDir}${a}`), new ArrayBuffer(0))
                : void 0
          )
          .then((i) => {
            o = this.loadMotion(
        ...
        fetch(`${this._modelHomeDir}${i}`)
          .then((t) =>
            t.ok
              ? t.arrayBuffer()
              : t.status >= 400
                ? (b(`Failed to load file ${this._modelHomeDir}${i}`), new ArrayBuffer(0))
                : void 0
          )
          .then((i) => {
            ...
            ;(null != r
              ? (r.setEffectIds(this._eyeBlinkIds, this._lipSyncIds),
                null != this._motions.getValue(s) && Lt.delete(this._motions.getValue(s)),
...
class ds {
  ...
  onTap(t, e) {
    ...
    i.hitTest('Head', t, e)
      ...
      : i.hitTest(st, t, e) &&
        i.startRandomMotion('TapBody', 2, this.finishedMotion, this.beganMotion)
  }
  onUpdate() {
...
class _s {
  ...
  createTextureFromPngFile(t, e, i) {
    for (let s = this._textures.begin(); s.notEqual(this._textures.end()); s.preIncrement())
      if (s.ptr().fileName == t && s.ptr().usePremultply == e)
        return (
          (s.ptr().img = new Image()),
          s.ptr().img.addEventListener('load', () => i(s.ptr()), { passive: !0 }),
    ...
    ;(s.addEventListener(
      ...
      () => {
        ...
        ;(this._glManager.getGl().bindTexture(this._glManager.getGl().TEXTURE_2D, r),
          this._glManager
            .getGl()
            .texParameteri(
  ...
  releaseTextures() {
    for (let t = 0; t < this._textures.getSize(); t++)
      (this._glManager.getGl().deleteTexture(this._textures.at(t).id), this._textures.set(t, null))
...
class ps {
  ...
  isHit(t, e) {
    const { height: i } = this._subdelegate.getCanvas(),
      s = i - e
    return (
      t >= this._rect.left && t <= this._rect.right && s <= this._rect.up && s >= this._rect.down
    )
  }
  setSubdelegate(t) {
    this._subdelegate = t
  ...
  initializeSprite() {
    ...
    ;(i.createTextureFromPngFile(s + r, !1, (i) => {
      const s = 0.5 * t,
        ...
        a = 2 * i.width,
        n = 0.95 * e
      ;((this._back = new ps(s, r, a, n, i.id)), this._back.setSubdelegate(this._subdelegate))
    }),
      (r = 'icon_gear.png'))
    ;(i.createTextureFromPngFile(s + r, !1, (i) => {
      const s = t - 0.5 * i.width,
        ...
        a = i.width,
        n = i.height
      ;((this._gear = new ps(s, r, a, n, i.id)), this._gear.setSubdelegate(this._subdelegate))
    }),
...
class Cs {
  ...
  initialize(t) {
    ...
    return (
      this._frameBuffer || (this._frameBuffer = e.getParameter(e.FRAMEBUFFER_BINDING)),
      e.enable(e.BLEND),
...
class Ms {
  ...
  run() {
    const t = () => {
      if (null != xs) {
        at.updateTime()
        for (let t = 0; t < this._subdelegates.getSize(); t++) this._subdelegates.at(t).update()
  ...
  initializeEventListener() {
    ;((this.pointBeganEventListener = this.onPointerBegan.bind(this)),
      ...
      document.addEventListener('pointerdown', this.pointBeganEventListener, { passive: !0 }),
      document.addEventListener('pointermove', this.pointMovedEventListener, { passive: !0 }),
      document.addEventListener('pointerup', this.pointEndedEventListener, { passive: !0 }),
      document.addEventListener('pointercancel', this.pointCancelEventListener, { passive: !0 }))
  }
  initializeCubism() {
    ;(at.updateTime(),
...
class bs extends Ms {
  ...
  stop() {
    this._drawFrameId &&
      (window.cancelAnimationFrame(this._drawFrameId), (this._drawFrameId = null))
  }
  release() {
    ;(this.stop(),
      this.releaseEventListener(),
  ...
  onMouseMove(t) {
    ...
    ;(e.onDrag(i, s),
      e.onTap(i, s),
      r.hitTest(st, i, s) && window.dispatchEvent(new Event('live2d:hoverbody')))
  }
  onMouseEnd(t) {
    const e = this._subdelegates.at(0).getLive2DManager(),
      { x: i, y: s } = this.transformOffset(t)
  ...
  initializeEventListener() {
    ;((this.mouseMoveEventListener = this.onMouseMove.bind(this)),
      ...
      document.addEventListener('mousemove', this.mouseMoveEventListener, { passive: !0 }),
      document.addEventListener('mouseout', this.mouseEndedEventListener, { passive: !0 }),
      document.addEventListener('pointerdown', this.tapEventListener, { passive: !0 }))
  }
  releaseEventListener() {
    ;(document.removeEventListener('mousemove', this.mouseMoveEventListener, { passive: !0 }),
      (this.mouseMoveEventListener = null),
      document.removeEventListener('mouseout', this.mouseEndedEventListener, { passive: !0 }),
      (this.mouseEndedEventListener = null),
      document.removeEventListener('pointerdown', this.tapEventListener, { passive: !0 }))
  }
  initializeSubdelegates() {
